...
# record
TRAIN_BACKUPDIR = 'fpn_res18_trainbackup_coco'
TRAIN_LOGFILE = 'fpn_res18_trainbackup_coco/train.log'
TEST_BACKUPDIR = 'fpn_res18_testbackup_coco'
TEST_LOGFILE = 'fpn_res18_testbackup_coco/test.log'
TEST_BBOXES_SAVE_PATH = 'fpn_res18_testbackup_coco/fpn_res18_detection_results_coco.json'
SAVE_INTERVAL = 1